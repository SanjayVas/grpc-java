  ...
  private static SslContext buildSslContext(
    ...
    if (trustCertCollectionFilePath != null) {
      builder.trustManager(
          BouncyCastle.readCertificateCollection(new File(trustCertCollectionFilePath)));
    }
    if (clientCertChainFilePath != null && clientPrivateKeyFilePath != null) {
      builder.keyManager(
          BouncyCastle.readPrivateKey(new File(clientPrivateKeyFilePath)),
          BouncyCastle.readCertificate(new File(clientCertChainFilePath)));
    }
  ...
  public static void main(String[] args) throws Exception {
    ...
    switch (args.length) {
      case 2:
        ...
        client =
            new HelloWorldClientTls(
                args[0], Integer.parseInt(args[1]), buildSslContext(null, null, null));
        break;
      case 3:
        client =
            new HelloWorldClientTls(
                args[0], Integer.parseInt(args[1]), buildSslContext(args[2], null, null));
        break;
      default:
        client =
            new HelloWorldClientTls(
                args[0], Integer.parseInt(args[1]), buildSslContext(args[2], args[3], args[4]));
    }
